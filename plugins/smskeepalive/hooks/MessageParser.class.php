...
class MessageParser
{
    ...
    */
    ...
    CONST TOKENS_TYPE_CHECKIN     = "ci,check,checkin,check in,in";
    CONST TOKENS_TYPE_CHECKOUT    = "co,checkout,check out,out";
    CONST TOKENS_TYPE_HELP        = "lp,help,sos,911";
    CONST TOKENS_TYPE_ALL_CLEAR   = "ac,clear,safe,allclear,all clear";
    ...
    public function __construct($message, $camefrom, $wentto){
        ...
        $this->message_type = strtolower(self::find_message_type($elements[0]));
